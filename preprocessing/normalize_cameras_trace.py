...
def normalize_cameras(original_cameras_filename,output_cameras_filename,num_of_cameras, scene_bounding_sphere=3.0):
    ...
    max_human_sphere_file = np.load(args.max_human_sphere_file) * 1.1
    print("max_human_sphere_file", max_human_sphere_file)

    if max_human_sphere_file > max_radius:
        max_radius = max_human_sphere_file
...
if __name__ == "__main__":
    ...
    parser.add_argument('--max_human_sphere_file', type=str, default="max_human_sphere.npy",
                        help='the output max human sphere file')

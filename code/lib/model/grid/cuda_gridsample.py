...
gridsample_grad2 = load(name='gridsample_grad2', sources=['/cluster/project/infk/hilliges/jiangze/V2A/RGB-PINA/code/lib/model/grid/gridsample_cuda.cpp', '/cluster/project/infk/hilliges/jiangze/V2A/RGB-PINA/code/lib/model/grid/gridsample_cuda.cu'], verbose=True)
